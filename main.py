...
def main():
    ...
    with open(os.path.join(directory, "zzz.bat"), 'w') as file:
        file.write(
            ...
            "setlocal\n\n"
            ":loop\n"
            f"REM Change directory to the location of the source file\n"
            f"cd /d \"{directory}\"\n\n"
            "REM Wait for 'Final_out.aqp' to exist in the directory\n"
            ":WaitForFile\n"
            "if not exist \"Final_out.aqp\" (\n"
            "    echo Waiting for 'Final_out.aqp' to appear...\n"
            "    timeout /t 1 >nul\n"
            "    goto WaitForFile\n"
            ")\n\n"
            "REM File found, proceed with operations\n"
            "echo File found, proceeding with operations...\n\n"
            "REM Rename the file\n"
            ...
            ":WaitForFile\n"
            f"if not exist \"{base_name}_ext.ice\" (\n"
            f"    echo Waiting for '{base_name}_ext.ice' to appear...\n"
            "    timeout /t 1 >nul\n"
            "    goto WaitForFile\n"
            ")\n\n"
